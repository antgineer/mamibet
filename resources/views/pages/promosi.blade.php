        ...
        <div class="container">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="header-bottom">
                    ...
                    <h1 class="title2">Promosi Terbaru MAMIBET</h1>
                    </div>
                        ...
                        <div class="panel-group" id="accordion">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <a data-toggle="collapse" data-parent="#accordion" href="#check{{$promo->id}}">
                                            <span class="acc-icons"></span><img src="/storage/cover_images/{{$promo->gambar}}"/>
                                        </a>
                                    </h4>
                                </div>
                            <div id="check{{$promo->id}}" class="panel-collapse collapse">
